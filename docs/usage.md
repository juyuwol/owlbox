...
호스팅사인 Vercel의 정책에 따라, 무료 계정은 **1시간 내 32회, 24시간 내 100회**까지의 배포(deployment: 빌드의 결과) 생성이 가능합니다. (2025년 11월 3일 기준) 최신의 정확한 정보는 [Vercel 공식 Limits 문서](https://vercel.com/docs/limits)에서 확인해 주세요.
